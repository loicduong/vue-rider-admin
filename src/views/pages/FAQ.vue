...
import KTPublications from '@/components/about-us/Publications.vue'
import KTSocialLinks from '@/components/about-us/SocialLinks.vue'
import { setCurrentPageBreadcrumbs } from '@/core/helpers/breadcrumb'
import { onMounted } from 'vue'

onMounted(() => {
  setCurrentPageBreadcrumbs('FAQ', ['Pages', 'FAQ'])
})
</script>
...
<template>
  ...
  <div class="card">
    ...
    <div class="card-body p-lg-20">
      ...
      <div class="mb-20">
        <!-- begin::Title -->
        <h1 class="fs-2x text-gray-800 w-bolder mb-6">
      ...
      <div class="row mb-20">
        ...
        <div class="col-md-6 pe-md-10 mb-10 mb-md-0">
          <!-- begin::Title -->
          <h1 class="text-gray-800 fw-bolder mb-4">
            Buying Product
          </h1>
          <!-- end::Title -->
          ...
          <div class="m-0">
            ...
            >
              ...
              >
                <span class="svg-icon toggle-on svg-icon-primary svg-icon-1">
                  <InlineSvg src="/media/icons/duotune/general/gen036.svg" />
                </span>
            ...
            <!-- begin::Body -->
            <div id="kt_job_4_1" class="fs-6 ms-1 collapse show">
              <!-- begin::Text -->
          ...
          <div class="m-0">
            ...
            >
              ...
              <!-- begin::Title -->
              <h4 class="text-gray-700 fw-bolder cursor-pointer mb-0">
                Do I need a designer to use Rider?
              </h4>
              <!-- end::Title -->
            </div>
            <!-- end::Heading -->
        ...
        <div class="col-md-6 ps-md-10">
          ...
          <div class="m-0">
            ...
            <!-- begin::Body -->
            <div id="kt_job_5_1" class="fs-6 ms-1 collapse show">
              <!-- begin::Text -->
              <div class="mb-4 text-gray-600 fw-bold fs-6 ps-10">
                First, a disclaimer – the entire process of writing a blog post
                often takes more than a couple of hours, even if you can type
      ...
      <div class="row mb-20">
        ...
        <div class="col-md-6 pe-md-10 mb-10 mb-md-0">
          <!-- begin::Title -->
          <h1 class="text-gray-800 w-bolder mb-4">
            User Roles
          </h1>
          <!-- end::Title -->
        ...
        <div class="col-md-6 ps-md-10">
          ...
          <div class="m-0">
            ...
            <!-- begin::Body -->
            <div id="kt_job_7_1" class="fs-6 ms-1 collapse show" style="">
              <!-- begin::Text -->
              <div class="mb-4 text-gray-600 fw-bold fs-6 ps-10">
                First, a disclaimer – the entire process of writing a blog post
                often takes more than a couple of hours, even if you can type

...
const items = [
  ...
  {
    photo: '/media/avatars/150-3.jpg',
    name: 'Melisa Marcus',
    position: 'Creative Director',
  },
  {
    photo: '/media/avatars/150-4.jpg',
    name: 'David Nilson',
    position: 'Python Expert',
  },
  {
    photo: '/media/avatars/150-5.jpg',
    name: 'Anne Clarc',
    position: 'Project Manager',
  },
  {
    photo: '/media/avatars/150-6.jpg',
    name: 'Ricky Hunt',
    position: 'Art Director',
  },
  {
    photo: '/media/avatars/150-7.jpg',
    name: 'Alice Wayde',
...
<template>
  ...
  <div :class="classes">
    ...
    <div class="tns tns-default mb-10">
      ...
      >
        <template v-for="(item, i) in items" :key="i">
          ...
          <div class="text-center">
            ...
            <div class="mb-0">
              <!-- begin::Name -->
              <a href="#" class="text-dark fw-bolder text-hover-primary fs-3">{{
                item.name
              }}</a>
              <!-- end::Name -->
      ...
      <!-- begin::Button -->
      <button id="kt_team_slider_prev" class="btn btn-icon btn-active-color-primary">
        <span class="svg-icon svg-icon-3x">
          <InlineSvg src="/media/icons/duotune/arrows/arr074.svg" />
        </span>
      </button>
      <!-- end::Button -->

      <!-- begin::Button -->
      <button id="kt_team_slider_next" class="btn btn-icon btn-active-color-primary">
        <span class="svg-icon svg-icon-3x">
          <InlineSvg src="/media/icons/duotune/arrows/arr071.svg" />
        </span>
      </button>
      <!-- end::Button -->
    </div>

        ...
        <div id="kt_header_search_toggle" class="d-flex align-items-center">
          <div class="btn btn-icon btn-active-light-primary">
            <span class="svg-icon svg-icon-1">
              <InlineSvg src="/media/icons/duotune/general/gen021.svg" />
            </span>
          </div>
        </div>
        <!-- end::Search toggle -->
        ...
        <div>
          ...
          <form class="w-100 position-relative mb-3" autocomplete="off">
            ...
            <div class="position-absolute top-50 end-0 translate-middle-y">
              ...
              >
                <span class="svg-icon svg-icon-1">
                  <InlineSvg src="/media/icons/duotune/coding/cod001.svg" />
                </span>
              </div>
              ...
              >
                <span class="svg-icon svg-icon-2">
                  <InlineSvg src="/media/icons/duotune/arrows/arr072.svg" />
                </span>
              </div>
          ...
          <Main v-else-if="state === 'main'" />
          <Empty v-else-if="state === 'empty'" />
        </div>
        <!-- end::Wrapper -->

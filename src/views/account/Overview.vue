...
<template>
  ...
  <div id="kt_profile_details_view" class="card mb-5 mb-xl-10">
    ...
    <div class="card-header cursor-pointer">
      ...
      <!-- begin::Action -->
      <RouterLink to="/account/settings" class="btn btn-primary align-self-center">
        Edit Profile
      </RouterLink>
      <!-- end::Action -->
    </div>
    ...
    <div class="card-body p-9">
      ...
      <div class="row mb-7">
        ...
        <label class="col-lg-4 fw-bold text-muted">
          Country
          <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Country of origination" />
        </label>
        <!-- end::Label -->
      ...
      >
        <span class="svg-icon svg-icon-2tx svg-icon-warning me-4">
          <InlineSvg src="/media/icons/duotune/general/gen044.svg" />
        </span>
  ...
  <KTChartWidget2 widget-classes="mb-5 mb-xl-10" />

  <KTTableWidget1 widget-classes="mb-5 mb-xl-10" />

  <KTListWidget4 widget-classes="mb-5 mb-xl-10" />
</template>

...
onMounted(() => {
  bodyStore.addBodyClassName('print-content-only')

  setCurrentPageBreadcrumbs('Invoices', ['Pages', 'Invoices'])
})

onUnmounted(() => {
  bodyStore.removeBodyClassName('print-content-only')
})
      ...
      <div class="d-flex flex-column flex-xl-row">
        ...
        <div class="flex-lg-row-fluid me-xl-18 mb-10 mb-xl-0">
          ...
          <div class="d-flex flex-stack mb-10 mb-lg-15">
            <!-- begin::Logo -->
            <a href="#">
              <img alt="Logo" class="h-75px" src="/media/svg/brand-logos/quilosa.svg">
            </a>
            <!-- end::Logo -->
            ...
            <div class="my-1">
              ...
              <button class="btn btn-sm btn-success me-2" @click="print()">
                Print
              </button>
              ...
              <div class="col-sm-6">
                ...
                >
                  ...
                  <span class="fs-7 text-danger d-flex align-items-center">
                    <span class="bullet bullet-dot bg-danger me-2" />
                  ...
                  <tbody>
                    <tr class="fw-bolder text-gray-700 fs-5 text-end">
                      <td class="d-flex align-items-center pt-6">
                        <i class="fa fa-genderless text-danger fs-2 me-2" />
                    ...
                    <tr class="fw-bolder text-gray-700 fs-5 text-end">
                      <td class="d-flex align-items-center">
                        <i class="fa fa-genderless text-success fs-2 me-2" />
                    ...
                    <tr class="fw-bolder text-gray-700 fs-5 text-end">
                      <td class="d-flex align-items-center">
                        <i class="fa fa-genderless text-primary fs-2 me-2" />
          ...
          >
            ...
            <div class="mb-15">
              ...
              <div class="fw-bolder fs-6 text-gray-800 d-flex align-items-center">
                ...
                <span class="fs-7 text-danger d-flex align-items-center">
                  <span class="bullet bullet-dot bg-danger mx-2" />
            ...
            <div class="m-0">
              ...
              <div class="fw-bolder fs-6 text-gray-800 d-flex align-items-center">
                ...
                <span class="fs-7 text-success d-flex align-items-center">
                  <span class="bullet bullet-dot bg-success mx-2" />

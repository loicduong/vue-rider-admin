    ...
    <template #content>
      ...
      >
        ...
        >
          <template v-for="(item, i) in MainMenuConfig" :key="i">
            ...
            <template v-for="(menuItem, j) in item.pages" :key="j">
              <template v-if="menuItem.heading">
                  ...
                  <div class="menu-link">
                    <span v-if="menuItem.svgIcon" class="menu-icon">
                      <span class="svg-icon svg-icon-2">
                        <InlineSvg :src="menuItem.svgIcon" />
                      </span>
                    </span>
                ...
                <div v-if="!menuItem.pro" class="menu-item">
                  <RouterLink v-slot="{ href, navigate, isActive, isExactActive }" :to="menuItem.route">
                    <a
                    ...
                    >
                      <span v-if="menuItem.svgIcon || menuItem.fontIcon" class="menu-icon">
                        <i v-if="asideMenuIcons === 'font'" :class="menuItem.fontIcon" class="bi fs-3" />
          ...
          <div class="menu-item">
            <a class="menu-link" href="https://preview.keenthemes.com/rider-vue-free-docs/#/utilities">
              <span class="menu-icon">
                <span class="svg-icon svg-icon-2">
                  <InlineSvg src="/media/icons/duotune/layouts/lay009.svg" />
                </span>
              </span>
          ...
          <div class="menu-item">
            <a class="menu-link" href="https://preview.keenthemes.com/rider-vue-free-docs/#/overview">
              <span class="menu-icon">
                <span class="svg-icon svg-icon-2">
                  <InlineSvg src="/media/icons/duotune/abstract/abs027.svg" />
                </span>
              </span>
          ...
          <div class="menu-item">
            <div class="menu-link">
              <span class="menu-icon">
                <span class="svg-icon svg-icon-2">
                  <InlineSvg src="/media/icons/duotune/general/gen019.svg" />
                </span>
              </span>
              <span class="menu-title">{{ translate("layoutBuilder") }}
                <span
                  class="
                    badge badge-pro badge-light-danger
                    fw-bold
          ...
          <div class="menu-item">
            <a class="menu-link" href="https://preview.keenthemes.com/rider-vue-free-docs/#/changelog">
              <span class="menu-icon">
                <span class="svg-icon svg-icon-2">
                  <InlineSvg src="/media/icons/duotune/general/gen005.svg" />
                </span>
              </span>

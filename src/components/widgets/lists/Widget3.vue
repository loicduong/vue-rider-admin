...
<template>
  ...
  <div :class="widgetClasses" class="card card-flush">
    ...
    <div class="card-header">
      <!-- begin::Card title -->
      <h3 class="card-title fw-boldest">
        Latest Authors Sales
      </h3>
      <!-- end::Card title -->
      ...
      <div class="card-toolbar">
        ...
        >
          <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="Add New User">
            <span class="svg-icon svg-icon-2">
              <InlineSvg src="/media/icons/duotune/general/gen035.svg" />
            </span>
          </span>
        </a>
        <!-- end::Icon -->
        ...
        >
          <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="Add New Card">
            <span class="svg-icon svg-icon-1">
              <InlineSvg src="/media/icons/duotune/general/gen006.svg" />
            </span>
          </span>
        </a>
        <!-- end::Icon -->
        ...
        <div class="d-flex align-items-center">
          ...
          >
            <span class="svg-icon svg-icon-1">
              <InlineSvg src="/media/icons/duotune/general/gen023.svg" />
            </span>
          </a>
          <Dropdown1 />
          <!-- end::Icon -->
    ...
    <div class="card-body pt-1">
      ...
      <div class="tab-content">
        <!-- begin::Tab pane -->
        <div id="kt_lists_widget_3_tab_pane_1" class="tab-pane fade active show">
          <!-- begin::Section -->
          <div class="mb-7">
            <!-- begin::Heading -->
            <div class="fw-bold fs-4 text-gray-400 mb-5">
              24 Sep, 2021
            </div>
            <!-- end::Heading -->
            ...
            <div class="overflow-auto mb-10">
              <template v-for="(item, i) in authors1" :key="i">
                <!-- begin::Item -->
                <div :class="[i !== authors1.length - 1 && 'mb-7']" class="d-flex align-items-center">
                  <!-- begin::Avatar -->
                  <div class="symbol symbol-40px symbol-circle me-4">
                    <img v-if="item.user.src" alt="Pic" :src="item.user.src">
                    <span
                      v-else
                      :class="`bg-light-${item.user.state} text-${item.user.state}`"
                      class="symbol-label fw-boldest"
                    >
                      {{ item.user.initials }}
                    </span>
                  </div>
                  ...
                  <div class="d-flex flex-column min-w-150px me-4">
                    <a href="#" class="fw-boldest text-gray-800 text-hover-primary fs-4">{{ item.title }}</a>
          ...
          <div class="mb-7">
            ...
            <div class="overflow-auto">
              <template v-for="(item, i) in authors2" :key="i">
                <!-- begin::Item -->
                <div :class="[i !== authors2.length - 1 && 'mb-7']" class="d-flex align-items-center">
                  <!-- begin::Avatar -->
                  <div class="symbol symbol-40px symbol-circle me-4">
                    <img v-if="item.user.src" alt="Pic" :src="item.user.src">
                    <span
        ...
        <!-- begin::Tab pane -->
        <div id="kt_lists_widget_3_tab_pane_2" class="tab-pane fade">
          <!-- begin::Chart -->
        ...
        <!-- begin::Tab pane -->
        <div id="kt_lists_widget_3_tab_pane_3" class="tab-pane fade">
          <!-- begin::Items -->
          <div class="mb-0">
            <template v-for="(item, i) in trends" :key="i">
              <!-- begin::Item -->
              <div :class="[i !== trends.length - 1 && 'mb-7']" class="d-flex align-items-sm-center">
                <!-- begin::Symbol -->

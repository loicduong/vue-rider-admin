  ...
  <div class="d-flex flex-column flex-xl-row">
    ...
    <div class="flex-column flex-lg-row-auto w-100 w-xl-325px mb-10">
      ...
      <div
        ...
        data-kt-sticky="true"
        data-kt-sticky-name="account-navbar"
        data-kt-sticky-offset="{default: false, xl: '80px'}"
        data-kt-sticky-width="{lg: '250px', xl: '325px'}"
        data-kt-sticky-left="auto"
        data-kt-sticky-top="90px"
      ...
      >
        ...
        <div class="card-body pt-0 p-10">
          ...
          <div class="d-flex flex-center flex-column mb-10">
            ...
            <!-- begin::Position -->
            <div class="fs-6 fw-bold text-gray-400 mb-2">
              Art Director
            </div>
            <!-- end::Position -->
            ...
            <div class="d-flex flex-center">
              <RouterLink to="/chat/private-chat" class="btn btn-sm btn-light-primary py-2 px-4 fw-bolder me-2">
                Send
                Message
              </RouterLink>
            </div>
          ...
          >
            <li class="menu-item mb-1">
              <!-- begin::Menu link -->
              <RouterLink class="menu-link px-6 py-4" to="overview" active-class="active">
            ...
            <li class="menu-item mb-1">
              <!-- begin::Menu link -->
              <RouterLink class="menu-link px-6 py-4" to="settings" active-class="active">
                <span class="menu-bullet"><span class="bullet" /></span>
            ...
            <li class="menu-item mb-1">
              <!-- begin::Menu link -->
              <RouterLink class="menu-link px-6 py-4" to="security" active-class="active">
                <span class="menu-bullet"><span class="bullet" /></span>
            ...
            <li class="menu-item mb-1">
              <!-- begin::Menu link -->
              <RouterLink class="menu-link px-6 py-4" to="audit-logs" active-class="active">
                <span class="menu-bullet"><span class="bullet" /></span>
            ...
            <li class="menu-item mb-1">
              <!-- begin::Menu link -->
              <RouterLink class="menu-link px-6 py-4" active-class="active" to="activity">
                <span class="menu-bullet"><span class="bullet" /></span>

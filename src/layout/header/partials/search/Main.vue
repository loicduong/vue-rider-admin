    ...
    <div class="scroll-y mh-200px mh-lg-325px">
        ...
        <div class="symbol symbol-40px symbol-circle me-4">
          <span class="symbol-label bg-light">
            <span class="svg-icon svg-icon-2 svg-icon-primary">
              <InlineSvg src="/media/icons/duotune/electronics/elc004.svg" />
            </span>
          </span>
        </div>
        <!-- end::Symbol -->
      ...
      <div class="d-flex align-items-center mb-5">
        ...
        <div class="symbol symbol-40px symbol-circle me-4">
          <span class="symbol-label bg-light">
            <span class="svg-icon svg-icon-2 svg-icon-primary">
              <InlineSvg src="/media/icons/duotune/graphs/gra001.svg" />
            </span>
          </span>
        </div>
        <!-- end::Symbol -->
      ...
      <div class="d-flex align-items-center mb-5">
        ...
        <div class="symbol symbol-40px symbol-circle me-4">
          <span class="symbol-label bg-light">
            <span class="svg-icon svg-icon-2 svg-icon-primary">
              <InlineSvg src="/media/icons/duotune/graphs/gra006.svg" />
            </span>
          </span>
        </div>
        <!-- end::Symbol -->
      ...
      <div class="d-flex align-items-center mb-5">
        ...
        <div class="symbol symbol-40px symbol-circle me-4">
          <span class="symbol-label bg-light">
            <span class="svg-icon svg-icon-2 svg-icon-primary">
              <InlineSvg src="/media/icons/duotune/graphs/gra002.svg" />
            </span>
          </span>
        </div>
        <!-- end::Symbol -->
      ...
      <div class="d-flex align-items-center mb-5">
        ...
        <div class="symbol symbol-40px symbol-circle me-4">
          <span class="symbol-label bg-light">
            <span class="svg-icon svg-icon-2 svg-icon-primary">
              <InlineSvg src="/media/icons/duotune/communication/com010.svg" />
            </span>
          </span>
        </div>
        <!-- end::Symbol -->
      ...
      <div class="d-flex align-items-center mb-5">
        ...
        <div class="symbol symbol-40px symbol-circle me-4">
          <span class="symbol-label bg-light">
            <span class="svg-icon svg-icon-2 svg-icon-primary">
              <InlineSvg src="/media/icons/duotune/finance/fin001.svg" />
            </span>
          </span>
        </div>
        <!-- end::Symbol -->
